...
namespace WebShopCleanCode
{
    public class Customer
    {
        ...
        public Customer(string username, string password, string firstName, string lastName, string email, int age, string address, string phoneNumber, int funds, List<Order> orders) : this(username, password, firstName, lastName, email, age, address, phoneNumber)
        {
        }
